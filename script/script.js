document.addEventListener("DOMContentLoaded", () => {
  ...
  mobileBtn.addEventListener("click", () => {
    // escucha el evento de click en el botón de menú móvil
    ...
    if (navMenu.classList.contains("open")) {
      // si el menú tiene la clase "open", significa que está abierto, por lo que se cambia el icono a "close" para indicar que el menú se puede cerrar
      icon.textContent = "close"; // cambia el texto del icono a "close" para indicar que el menú está abierto y se puede cerrar
    } else {
      // si el menú no tiene la clase "open", significa que está cerrado, por lo que se cambia el icono a "menu" para indicar que el menú se puede abrir
  ...
  document.querySelectorAll(".nav-menu a").forEach((link) => {
    // selecciona todos los enlaces dentro del menú de navegación y agrega un evento de click a cada uno
    link.addEventListener("click", () => {
      // escucha el evento de click en cada enlace del menú de navegación
...
nextBtn.addEventListener("click", () => {
  // Agrega un evento de click al botón "next" para desplazar el slider hacia la derecha cuando se hace click en el botón "next", el slider se desplazará horizontalmente hacia la derecha para mostrar los siguientes productos disponibles en el slider, permitiendo al usuario navegar a través de los productos de manera fácil y rápida
  slider.scrollLeft += 350; // Desplaza a la derecha
});

prevBtn.addEventListener("click", () => {
  // Agrega un evento de click al botón "prev" para desplazar el slider hacia la izquierda cuando se hace click en el botón "prev", el slider se desplazará horizontalmente hacia la izquierda para mostrar los productos anteriores disponibles en el slider, permitiendo al usuario navegar a través de los productos de manera fácil y rápida
